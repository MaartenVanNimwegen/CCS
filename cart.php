...
<td><a href='versturen.php?naam=$result[naam]&telef=$result[telef]&email=$result[email]&datum=$result[datum]&product=$result[name]&product=$result[quantity]&totaal=$result[totaal]' onclick='return checkdelete()'><input type='submit' value='bestellen'></a></td>
</tr>
</tbody>
</table>		
  <?php
